...
omxplayer -o local --win '150 150 1920 1080' /media/PiShare/lineshaft_1300x900.mp4 #launch the video // TO DO: replace this with variables for video and window size, or make easily replacable