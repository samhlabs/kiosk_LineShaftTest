...
omxplayer -o local --win '150 0 1770 1080' /media/PiShare/lineshaft_1300x900.mp4 #launch the video // TO DO: replace this with variables for video and window size, or make easily replacable